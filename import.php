    ...
    <div ng-repeat="log in logList">
      <div class="panel" ng-class="{'panel-primary': log.active, 'panel-info': !log.active}">
        ...
        <div class="panel-body">
          ...
          <div ng-if="log.tokenUrl && log.foundLangs.length > 1">
            <span ng-repeat="taskLang in log.foundLangs"><a class="btn btn-default" href="{{ log.tokenUrl }}&sLanguage={{ taskLang }}" target="_blank"><span ng-i18next="task_test_lang"></span> {{ taskLang }}</a> </span>
